...
subtitle: "Session 1: Concepts & Motivation"
...
**Three simple pieces that work together:**

1. **Centralized Catalog** - One place to register and find all datasets
2. **Standardized Projects** - Consistent structure everyone understands
3. **Automated Workflows** - Version control and provenance tracking handled for you

**The framework helps with setup:**

- Configures S3 bucket access for data storage
- Sets up DVC (Data Version Control) automatically
...
::: {.notes}
Show concrete examples of each type. Data products are datasets that multiple projects use. Analysis projects are specific research questions. Infrastructure is shared code that multiple projects need. This separation keeps things organized and enables reuse.
:::
...
::: {.notes}
Access control is crucial for PHI/PII and data use agreements. The framework enforces policies automatically rather than relying on manual Dropbox folder sharing.
:::
...
::: {.notes}
Onboarding efficiency is a huge win. Junior researchers can be productive immediately because everything is documented and discoverable. No need for extensive institutional knowledge.
:::
...
::: {.notes}
Breaking down silos. Different research projects can build on each other's work. External collaborators can access exactly what they need without full lab access.
:::
...
- What datasets would you want to register first?
- What current pain points resonate most?
