...
::: {.column width="50%"}
**1. Data Products**
*Data foundations, reusable datasets*
- **Role:** Cleaning & processing
- **Output:** Versioned datasets
- **Example:** `data_cms-impactfile`
- **Contains:** Raw data, cleaning scripts
...
- **Input:** Uses Data Products
- **Example:** `prj_price-quality`
- **Contains:** 
  - Analysis code
  - code taken of enclaves 
  - Final code / results 
:::
...
** AI-assisted coding tools are becoming ubiquitous.**
...
**Bottom line:** Learning Git and DVC will prepare you for AI-assisted research.
