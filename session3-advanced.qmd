---
title: "Mintd: Advanced Topics & Adoption"
subtitle: "Session 3: Advanced Topics"
...
mint create data --name cms_nppes_merged --lang stata
...
```json
{
  ...
  "lineage": {
    "sources": ["cms-provider v1.2", "cms-nppes v2.3"],
...
mint create enclave --name fisma_research \
  --registry-url https://github.com/org-namee/data-registry
